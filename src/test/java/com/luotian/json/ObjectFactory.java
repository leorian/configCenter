...
public interface ObjectFactory {
     ...
     * the object should be fully constructed.  {@link ObjectBinder} can be used to bind values into
     * the object according to default rules.  For simple implementations you won't need to use this, but
     * for more complex or generic objects reusing methods like {@link ObjectBinder#bind(Object, Type)}
     * and {@link ObjectBinder#bindIntoCollection(java.util.Collection, java.util.Collection, Type)}.
     *
