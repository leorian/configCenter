...
import com.luotian.json.transformer.*;
...
public class TransformerUtil {
    ...
    static {
        ...
        defaultTransformers.put(Throwable.class, new TransformerWrapper(transformer));
        ...
        // Let the subclass Collection to match the iterable transformer,
        // to prevent the potential mismatch. e.g. SQLException which is
        // a iterable, however, the first entry is itself which would cause
        // StackOverflowError
        defaultTransformers.put(Collection.class, new TransformerWrapper(transformer));
        ...
        defaultTransformers.put(byte[].class, new TransformerWrapper(transformer));
