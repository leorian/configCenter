...
public enum MongoDBUtil {
    ...
    public static void main(String[] args) {
        ...
        String dbName = "configCenter";
        String collName = "ConfigSet";
        ...
        // 查询所有
        Bson filter = Filters.eq("key", "key03");
        System.out.println(JSON.toJSONString(MongoDBUtil.instance.find(coll, filter)));
